        ...
        <>
            ...
            <div className="block mx-auto mb-10 max-w-full items-center">
                ...
                <div className="md:flex ">
                    ...
                    <div className="md:flex w-1/2 items-center bg-blue-300 opacity-70">
                    <form className=" mx-auto shadow-md">
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6">
                            <div className="px-6">
                                ...
                                <textarea className=" -px-3 no-resize appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48 resize-none" id="message"></textarea>
                    ...
                    <div className="flex flex-1 py-5 justify-center bg-blue-200 items-center">
